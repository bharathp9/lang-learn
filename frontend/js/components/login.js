    ...
    <div class="min-h-screen gradient-bg flex items-center justify-center p-4">
        <div class="bg-white rounded-3xl shadow-2xl p-8 w-full max-w-md bounce-in">
            ...
            <div class="text-center mb-8">
                <h1 class="text-4xl font-bold text-primary mb-2">LangLearn</h1>
                <p class="text-gray-600 text-lg">Learn Telugu in 30 Days!</p>
            ...
            <div class="mb-6">
                ...
                <div class="flex justify-center gap-3 flex-wrap" id="avatar-select">
                    ${['🦁', '🐯', '🐻', '🐼', '🐨', '🐸', '🦊', '🐰'].map((emoji, i) => `
                        <button onclick="window.selectAvatar('${emoji}')" 
                            class="avatar-btn text-3xl p-2 rounded-xl border-2 ${i === 0 ? 'border-primary bg-orange-50' : 'border-gray-200'} hover:border-primary transition-all"
                            data-emoji="${emoji}">
                            ${emoji}
                        </button>
                    `).join('')}
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" id="display-name" placeholder="Enter your name" 
                        class="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-primary focus:outline-none text-lg">
                </div>
                <div>
                ...
                <button onclick="window.handleRegister()" 
                    class="w-full gradient-bg text-white font-bold py-4 rounded-xl text-lg hover:opacity-90 transition-all shadow-lg">
                    Start Learning! 🚀
                </button>
                ...
                <div>
                    <input type="text" id="login-username" placeholder="Enter existing username" 
                        class="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-secondary focus:outline-none text-lg mb-3">
                    <button onclick="window.handleLogin()" 
                        class="w-full bg-secondary text-white font-bold py-4 rounded-xl text-lg hover:opacity-90 transition-all shadow-lg">
                        Login
                    </button>
                </div>
            </div>
            ...
            <!-- Features -->
            <div class="mt-8 grid grid-cols-3 gap-2 text-center text-xs text-gray-500">
                <div class="p-2">
